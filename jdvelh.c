...
printf("[1] Route du désespoir \n[2] Route de la lumière");
    ...
    if (choix == 1){
        printf(" [1] %s \n", gauche.nomchemin, gauche.direction);
            ...
            printf("Vous avez vaincue cette route maudite! \n");
    }

    if (choix == 2){
        printf(" [2] %s \n", droite.nomchemin, droite.direction);
            printf("Rien ne vous arrivera sur ce chemin profiter de la vue! \n");
            printf("Vous ète arriver au bout de ce paisible chemin ! \n");
    }
